...
if (empty($conf->global->THEME_ELDY_ENABLE_PERSONALIZED))
{
    ...
    $conf->global->THEME_ELDY_FONT_SIZE1='10';
    $conf->global->THEME_ELDY_FONT_SIZE2='8';
}
...
div.liste_titre {
	min-height: 20px !important;	/* We cant use height because it's a div and it should be higher if content is more. but min-height does not work either for div */
...
#dolpaymenttable { width: 600px; font-size: 10px; }
...
.dp td, .tpHour td, .tpMinute td{padding:2px; font-size:14px;}
/* Barre titre */
...
.dpDayNames td,.dpExplanation {background-color:#D9DBE1; font-weight:bold; text-align:center; font-size:14px;}
.dpExplanation{ font-weight:normal; font-size:14px;}
...
.cal_event a:link    { color: #111111; font-size: 8px; font-weight: normal !important; }
.cal_event a:visited { color: #111111; font-size: 8px; font-weight: normal !important; }
.cal_event a:active  { color: #111111; font-size: 8px; font-weight: normal !important; }
.cal_event a:hover   { color: #111111; font-size: 8px; font-weight: normal !important; color:rgba(255,255,255,.75); }
.cal_event_busy      { }
.cal_peruserviewname { max-width: 100px; height: 14px; }
