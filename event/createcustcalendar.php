...
print '<th align="center" colspan="6">' . "calendrier des actions liées au client</th>";
print '</tr>';
...
$sql.= " WHERE c.type <> 'systemauto' AND a.fk_soc =" . $socid;
...
print '<td>Contact: ';
$form->select_contacts($socid, GETPOST('contactid'), 'contactid', 1, '', '', 0, 'minwidth200');
print '</td>';
