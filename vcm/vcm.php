...
print '<tr>';
	...
	print '<td align="center"></td>';
	print '<td align="center"></td>';
	print '<td>' . print_extra('vcm_ppc', 'bool', $action, $extrafields, $object,0) . ' oui</td>';
	print '</tr>';
	print '<tr bgcolor="aaffd4">';
	...
	print '<td align="center"> Inclus </td>';
	print '<td align="center"></td>';
	print '<td>' . print_extra('vcm_pc', 'bool', $action, $extrafields, $object,0) . ' oui</td>';
	print '</tr>';
	print '<tr bgcolor="aaffd4">';
	...
	print '<td align="center"> Inclus </td>';
	print '<td align="center"></td>';
	print '<td>' . print_extra('vcm_pcc', 'bool', $action, $extrafields, $object,0) . ' oui</td>';
	print '</tr>';
	print '</tr>';
	print '<tr bgcolor="aaffd4">';
	...
	print '<td align="center"> Inclus </td>';
	print '<td align="center">Inclus</td>';
	print '<td>' . print_extra('vcm_pvc', 'bool', $action, $extrafields, $object,0) . ' oui</td>';
	print '</tr>';
	print '<tr style="height:5px"><td colspan="7" style="height:5px"></td></tr>';
	...
	print '<td align="center"></td>';
	print '<td align="center"></td>';
	print '<td>' . print_extra('vcm_blue', 'bool', $action, $extrafields, $object,0) . ' oui</td>';
	print '</tr>';
	...
	print '<td align="center">Inclus</td>';
	print '<td align="center"></td>';
	print '<td>' . print_extra('vcm_silver', 'bool', $action, $extrafields, $object,0) . ' oui</td>';
	print '</tr>';
	...
	print '<td align="center">Inclus</td>';
	print '<td align="center"></td>';
	print '<td>' . print_extra('vcm_silverp', 'bool', $action, $extrafields, $object,0) . ' oui</td>';
	print '</tr>';
