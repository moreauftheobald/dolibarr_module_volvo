	...
	function write_file($object,$outputlangs,$srctemplatepath='',$hidedetails=0,$hidedesc=0,$hideref=0)
	{
		...
		if ($conf->commande->dir_output)
		{
			...
			if (file_exists($dir))
			{
                ...
                $default_font_size = pdf_getPDFFontSize($outputlangs)-3;	// Must be after pdf_getInstance
				...
				$y=array(25.5,37.3,49.5,61.8,65.8,70.2,97.2,103.3,107.8,112.3,118.2,122.7,127.2,131.7,138.7,143,147.7);
