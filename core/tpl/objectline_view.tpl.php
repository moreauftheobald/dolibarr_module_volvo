...
<tr <?php echo 'id="row-'.$line->id.'" '.$bcdd[$var]; ?>>
<td colspan="2" style="border-style:none"><b><u>facture de: </u></b><?php echo $extrafieldsline->showOutputField("fk_supplier",$line->array_options["options_fk_supplier"]);?></td>
<td colspan="2" style="border-style:none"><b><u>Reçue le:</u></b><?php echo $extrafieldsline->showOutputField("dt_invoice",$line->array_options["options_dt_invoice"]);?></td>
