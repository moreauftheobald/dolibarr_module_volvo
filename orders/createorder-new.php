...
print '<tr ' . $bc[$var] . '>';
print '<td align="center" width="33%">' . $langs->trans('Prix de vente du véhicule') . ': <input type="text" name="prixvente" size="7" value=""/> €</td>';
print '<td align="center" width="33%">' . $langs->trans('commission Dealer sur fiche de décision') . ': <input type="text" name="commission" size="7" value=""/> €</td>';
print '<td align="center" width="33%">' . $langs->trans('Date de livraison souhaitée') . ': ' . $form->select_date('', 'datelivprev_', 0, 0, 1, '', 1, 1, 1, 0, '', '', '') . '</td>';
print '</tr>';
print '</table>';
print '</td>';
print '</tr>';
